...
echo  ███████ ████████          █ █ █ ███ ███████  █████   █ ███ █████ █  ██  ██ ███  ███ █████   ██ ██  █
echo.
echo Версия программы 3.2025. Для проверки обновления нажмите Enter.
echo.
echo.
...
if "%updateChoice%"=="" (
    ...
    powershell -Command "(New-Object Net.WebClient).DownloadFile('https://aligatorru.github.io/nanoCAD_uninstall_bat/MegaUninstall%20nanoCAD%20Toll.bat', 'update.bat')"
